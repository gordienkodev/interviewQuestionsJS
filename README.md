...
Пример:
function curry(fn) {
    // Возвращаем новую функцию, которая будет использоваться для каррирования функции fn
    return function curried(...args) {
        // Проверяем, если количество переданных аргументов больше или равно ожидаемому количеству аргументов у fn
        if (args.length >= fn.length) {
            // Если аргументов достаточно, вызываем функцию fn с этими аргументами и возвращаем результат
            return fn(...args);
        } else {
            // Если аргументов недостаточно, возвращаем новую функцию, ожидающую оставшиеся аргументы
            return function(...nextArgs) {
                // Рекурсивно вызываем curried, добавляя к текущему списку аргументов оставшиеся аргументы

...
.centered-div {
    ...
    margin: auto; /* Автоматический отступ центрирует элемент по горизонтали */
}
2. С помощью Flexbox:
.container {
    ...
    height: 100vh; /* Высота контейнера, например, равная высоте окна браузера */
}
.centered-div {
    width: 200px; /* Ширина элемента */
    height: 200px; /* Высота элемента */
...
.container {
    ...
    place-items: center; /* Центрируем элемент как по горизонтали, так и по вертикали */
    height: 100vh; /* Высота контейнера, например, равная высоте окна браузера */
}
.centered-div {
    width: 200px; /* Ширина элемента */
...
4. С помощью position: absolute; и свойств top и left:
.container {
    position: relative; /* Позиционируем родительский контейнер */
    height: 100vh; /* Высота контейнера, например, равная высоте окна браузера */
}
.centered-div {
    position: absolute; /* Позиционируем элемент абсолютно */
    top: 50%; /* Сдвигаем верхний край элемента на 50% высоты контейнера */
    left: 50%; /* Сдвигаем левый край элемента на 50% ширины контейнера */
    transform: translate(-50%, -50%); /* Сдвигаем элемент обратно на 50% его собственной ширины и высоты */
    width: 200px; /* Ширина элемента */
    height: 200px; /* Высота элемента */
}
5. С помощью position: fixed; и свойств top и left:
.centered-div {
    position: fixed; /* Позиционируем элемент фиксированно */
    top: 50%; /* Сдвигаем верхний край элемента на 50% высоты окна браузера */
    left: 50%; /* Сдвигаем левый край элемента на 50% ширины окна браузера */
    transform: translate(-50%, -50%); /* Сдвигаем элемент обратно на 50% его собственной ширины и высоты */
    width: 200px; /* Ширина элемента */
    height: 200px; /* Высота элемента */
}
